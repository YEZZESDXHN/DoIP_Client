...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_DiagStepTree), QCoreApplication.translate("MainWindow", u"Tab 1", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_DiagServiceTree), QCoreApplication.translate("MainWindow", u"Tab 2", None))
