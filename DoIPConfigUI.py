...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget = QWidget(self.groupBox_DoIPConfig)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 60, 271, 31))
        ...
        self.lineEdit_DUTLogicalAddress = QLineEdit(self.widget)
        ...
        self.widget1 = QWidget(self.groupBox_DoIPConfig)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(10, 10, 271, 41))
        ...
        self.lineEdit_TesterLogicalAddress = QLineEdit(self.widget1)
        ...
        self.widget2 = QWidget(self.groupBox_DoIPConfig)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(10, 100, 201, 24))
        ...
        self.lineEdit_DUT_IP = QLineEdit(self.widget2)
