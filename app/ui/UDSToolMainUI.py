...
class Ui_UDSToolMainWindow(object):
    def setupUi(self, UDSToolMainWindow):
        ...
        self.action_Default = QAction(UDSToolMainWindow)
        ...
        self.action_Fusion = QAction(UDSToolMainWindow)
        self.action_Fusion.setObjectName(u"action_Fusion")
        self.action_Fusion.setCheckable(True)
        self.action = QAction(UDSToolMainWindow)
        self.action.setObjectName(u"action")
        self.action_2 = QAction(UDSToolMainWindow)
        ...
        self.gridLayout_2.addWidget(self.comboBox_ChooseConfig, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_EditConfig, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.comboBox_HardwareChannel, 1, 1, 1, 1)
        ...
        sizePolicy3.setHeightForWidth(self.comboBox_HardwareType.sizePolicy().hasHeightForWidth())
        self.comboBox_HardwareType.setSizePolicy(sizePolicy3)
        ...
        self.menu_set.addAction(self.menu.menuAction())
        self.menu.addAction(self.action_Default)
        self.menu.addAction(self.action_Fusion)
        self.menu_tool.addAction(self.action_database)
        self.menu_tool.addAction(self.action)
        self.menu_tool.addAction(self.action_2)
    ...
    def retranslateUi(self, UDSToolMainWindow):
        ...
        self.action_Default.setText(QCoreApplication.translate("UDSToolMainWindow", u"\u7cfb\u7edf\u9ed8\u8ba4", None))
        self.action_Fusion.setText(QCoreApplication.translate("UDSToolMainWindow", u"Fusion", None))
        self.action.setText(QCoreApplication.translate("UDSToolMainWindow", u"\u5bfc\u5165\u914d\u7f6e", None))
        self.action_2.setText(QCoreApplication.translate("UDSToolMainWindow", u"\u5bfc\u51fa\u914d\u7f6e", None))
        ...
        self.menu.setTitle(QCoreApplication.translate("UDSToolMainWindow", u"\u4e3b\u9898", None))
