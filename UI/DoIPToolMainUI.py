...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_2 = QHBoxLayout(self.tab_AutomatedDiagProcess)
        ...
        self.scrollArea_DiagTree_2 = QScrollArea(self.splitter_3)
        self.scrollArea_DiagTree_2.setObjectName(u"scrollArea_DiagTree_2")
        sizePolicy2.setHeightForWidth(self.scrollArea_DiagTree_2.sizePolicy().hasHeightForWidth())
        self.scrollArea_DiagTree_2.setSizePolicy(sizePolicy2)
        self.scrollArea_DiagTree_2.setMinimumSize(QSize(250, 0))
        self.scrollArea_DiagTree_2.setMaximumSize(QSize(16777215, 16777215))
        self.scrollArea_DiagTree_2.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.scrollArea_DiagTree_2.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
