...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_SecurityAccess = QLineEdit(self.tab_ExternalScript)
        self.lineEdit_SecurityAccess.setObjectName(u"lineEdit_SecurityAccess")
        self.lineEdit_SecurityAccess.setGeometry(QRect(80, 490, 311, 24))
        self.toolButton_SecurityAccess = QToolButton(self.tab_ExternalScript)
        self.toolButton_SecurityAccess.setObjectName(u"toolButton_SecurityAccess")
        self.toolButton_SecurityAccess.setGeometry(QRect(500, 490, 24, 24))
        self.pushButton_SecurityAccessTest = QPushButton(self.tab_ExternalScript)
        self.pushButton_SecurityAccessTest.setObjectName(u"pushButton_SecurityAccessTest")
        self.pushButton_SecurityAccessTest.setGeometry(QRect(500, 580, 95, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton_SecurityAccess.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.pushButton_SecurityAccessTest.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
